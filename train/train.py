...
def build_cnn(seq_length):
  ...
  model = tf.keras.Sequential([
      ...
      tf.keras.layers.MaxPool2D((1, 1), padding="valid", name="2ndPooling"),  # (batch, 14, 1, 16)
...
if __name__ == "__main__":
  ...
  intermediate_output = intermediate_layer_model(tf.convert_to_tensor(np.array(np.linspace(1,199,199)), dtype=tf.int64))
